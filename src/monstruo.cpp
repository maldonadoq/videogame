...
TMonstruo::TMonstruo(glm::vec3 _pos): TEnemigo(_pos){
    this->m_vida = 5;
    this->m_direccion = 10.0f*RandomVect();
    this->m_modelo = new TModelo(3, "data/modelo/monster/monster.obj", "data/modelo/monster/monster.jpg", GL_BGR_EXT, GL_RGB);
